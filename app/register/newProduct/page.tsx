...
export default function NewProduct() {
    ...
    return (
        <section className="h-full flex">
            <div className="flex my-auto flex-col dark:bg-default/50 bg-[#D4D4D8] relative md:gap-4 gap-2 xl:w-[40dvw] lg:w-[60dvw] w-full h-fit mx-auto md:p-5 p-3 rounded-sm">
                <HomeButton />
